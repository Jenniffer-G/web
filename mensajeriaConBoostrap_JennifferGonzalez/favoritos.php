...
<body>
	...
	<?php 
		...
		$mens = mysql_query("SELECT usuarios.Nombre, usuarios.URL, post.Titulo, post.Post, post.Id_mensaje FROM mensajes.usuarios JOIN mensajes.post ON post.Id_usuario = usuarios.Id JOIN mensajes.favoritos ON favoritos.Id_post = post.Id_mensaje WHERE favoritos.Id_usuario = '$idUser'");  
		...
		while ($row = mysql_fetch_array($mens)) {
			...
			$titulo = $row["Titulo"];
				...
				echo "<div class='contenedor container'>";
					echo "<div class='post col-lg-12 col-md-12 col-sm-3'>";
						echo "<div class='user'>";
